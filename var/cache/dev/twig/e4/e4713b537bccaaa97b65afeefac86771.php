...
class __TwigTemplate_76d51e044d0946bde38e04910f32115e extends Template
{
    ...
    ";
        ...
        // line 16
        yield "
    <h2 class=\"h3 mb-3 font-weight-normal\">Renseignez vos identifiants</h2>
    ...
    ";
        // line 37
        yield "
    <button class=\"btn btn-lg btn-outline-success mt-4\" type=\"submit\">
        Connexion
    </button>
</form>
<p class=\"mt-3\">Vous n'êtes pas inscrit ? <a href=\"";
        // line 42
        yield $this->extensions['Symfony\Bridge\Twig\Extension\RoutingExtension']->getPath("register");
        yield "\">Créez un compte ici</a></p>
";
    ...
    {
        return array (  153 => 42,  146 => 37,  140 => 24,  132 => 19,  127 => 16,  119 => 13,  116 => 12,  114 => 11,  111 => 10,  105 => 8,  103 => 7,  100 => 6,  87 => 5,  64 => 3,  41 => 1,);
    }
...
<form method=\"post\">
    ...
    {% if app.user %}
        <div class=\"mb-3\">
            Vous êtes connecté(e) en tant que {{ app.user.username }}, <a href=\"{{ path('app_logout') }}\">Logout</a>
        </div>
    {% endif %}
...
<p class=\"mt-3\">Vous n'êtes pas inscrit ? <a href=\"{{ path('register') }}\">Créez un compte ici</a></p>
{% endblock %}
", "security/login.html.twig", "E:\\laragon\\www\\projetSymfony\\templates\\security\\login.html.twig");
    }
}
