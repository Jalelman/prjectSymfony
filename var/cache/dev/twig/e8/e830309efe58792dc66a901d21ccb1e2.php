...
class __TwigTemplate_c77c4c3319107d3e1d0088068beded6d extends Template
{
...
$context["key"] == "hit_read_ratio")) {
                            // line 113
                            yield "                                                ";
                            yield (((array_key_exists("value", $context) &&  !(null === $context["value"]))) ? ($this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape($context["value"], "html", null, true)) : (0));
                            yield " <span class=\"unit\">%</span>
                                            ";
                        } else {
                            // line 115
...
{% block panel %}
    ...
    {% endif %}
{% endblock %}
", "@WebProfiler/Collector/cache.html.twig", "E:\\laragon\\www\\projetSymfony\\vendor\\symfony\\web-profiler-bundle\\Resources\\views\\Collector\\cache.html.twig");
    }
}
