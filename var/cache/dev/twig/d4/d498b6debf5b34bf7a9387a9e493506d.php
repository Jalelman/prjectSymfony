...
class __TwigTemplate_a91458ceca5a751267e31e35c9dc7828 extends Template
{
    ...
    ";
        ...
        <a href=\"";
        // line 23
        yield $this->extensions['Symfony\Bridge\Twig\Extension\RoutingExtension']->getPath("account_address");
        yield "\" class=\"list-group-item list-group-item-action\">
            Gérer mes adresses
        </a>
        <a href=\"";
        // line 26
        yield $this->extensions['Symfony\Bridge\Twig\Extension\RoutingExtension']->getPath("account_password");
        yield "\" class=\"list-group-item list-group-item-action\">
...
";
    ...
    {
        return array (  150 => 26,  144 => 23,  137 => 20,  129 => 16,  127 => 15,  124 => 14,  115 => 11,  112 => 10,  108 => 9,  103 => 7,  100 => 6,  87 => 5,  64 => 3,  41 => 1,);
    }
...
{% block title %}Mon compte - e-commerce{% endblock %}

{% block body %}
    <h2>Mon compte</h2>
    Bienvenue dans votre espace membre {{ app.user.firstname }}.
    <hr>
...
{% endblock %}
", "account/index.html.twig", "E:\\laragon\\www\\projetSymfony\\templates\\account\\index.html.twig");
    }
}
