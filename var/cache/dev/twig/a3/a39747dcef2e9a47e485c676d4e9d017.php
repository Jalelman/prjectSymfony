...
class __TwigTemplate_9723d90b3c815237eab893c58677bbc1 extends Template
{
    ...
    public function block_body(array $context, array $blocks = []): iterable
    {
        ...
        // line 6
        yield "    <h2>Confirmation de votre commande</h2>
    <p>
        Bonjour ";
        // line 8
        ...
        yield ", <br>
        Nous vous remercions de votre commande n° <b>";
        // line 9
        yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape(CoreExtension::getAttribute($this->env, $this->source, (isset($context["order"]) || array_key_exists("order", $context) ? $context["order"] : (function () { throw new RuntimeError('Variable "order" does not exist.', 9, $this->source); })()), "reference", [], "any", false, false, false, 9), "html", null, true);
        yield "</b>.<br>
    ...
    <p>
        ...
        // line 14
        yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape(CoreExtension::getAttribute($this->env, $this->source, (isset($context["order"]) || array_key_exists("order", $context) ? $context["order"] : (function () { throw new RuntimeError('Variable "order" does not exist.', 14, $this->source); })()), "carrierName", [], "any", false, false, false, 14), "html", null, true);
        yield " à l'adresse suivante: <br>
        ";
        // line 15
        yield CoreExtension::getAttribute($this->env, $this->source, (isset($context["order"]) || array_key_exists("order", $context) ? $context["order"] : (function () { throw new RuntimeError('Variable "order" does not exist.', 15, $this->source); })()), "delivery", [], "any", false, false, false, 15);
        yield "
    </p>
    <hr>
    <p>
        Pour suive votre commande, rendez-vous dans votre <a href=\"";
        // line 19
        yield $this->extensions['Symfony\Bridge\Twig\Extension\RoutingExtension']->getPath("account_orders");
        yield "\">compte</a>.
    </p>
";
    ...
    {
        return array (  129 => 19,  122 => 15,  118 => 14,  110 => 9,  104 => 8,  100 => 6,  87 => 5,  64 => 3,  41 => 1,);
    }
...
{% endblock %}", "payment/success.html.twig", "E:\\laragon\\www\\projetSymfony\\templates\\payment\\success.html.twig");
    }
}
